...
resource "aws_lambda_function" "tf_eventbus_lambda" {
  function_name = "tf_eventbus_lambda"
...
resource "aws_cloudwatch_event_target" "invoke_lambda" {
  ...
  target_id = "lambda"
  arn       = aws_lambda_function.tf_eventbus_lambda.arn
}
...
resource "aws_lambda_permission" "allow_eventbridge" {
  ...
  function_name = aws_lambda_function.tf_eventbus_lambda .function_name
